        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={5}
              className="w-full text-black border-2 border-gray-300 rounded-md p-3 mt-2 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-teal-400 transition duration-300 text-black"
            />
          </div>
